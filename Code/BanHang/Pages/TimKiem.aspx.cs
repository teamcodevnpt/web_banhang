            ...
            for (int i = 0; i < dts.Rows.Count; i++)
            {
                str += "<div class='col-md-3 col-xs-6'>" +
                    "<div class='media'>" +
                        ...
                        "<img class='img-responsive' style='height:150px;' src = '" + ResolveUrl(dts.Rows[i]["AVATAR"].ToString()) + "'/>" +
                        "<p style='color:orangered; font-size: medium; margin:0px; text-align:center'>" + dts.Rows[i]["TEN_SANPHAM"] + "</p>" +
                        "<p style='text-align:center'>" + dts.Rows[i]["GIA"] + "</p></a></div></div>";
            }
        }
        else
        {
